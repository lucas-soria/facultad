  ...
  return (
    <div>
      <h2 id="carro-compra-heading" data-cy="CarroCompraHeading">
        <Translate contentKey="carroDeComprasApp.carroCompra.home.title">Carro Compras</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="carroDeComprasApp.carroCompra.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="carroDeComprasApp.carroCompra.home.createLabel">Create new Carro Compra</Translate>
          </Link>
        </div>
      </h2>
        ...
        {carroCompraList && carroCompraList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="carroDeComprasApp.carroCompra.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {carroCompraList.map((carroCompra, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{carroCompra.cliente ? carroCompra.cliente.id : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="carroDeComprasApp.carroCompra.home.notFound">No Carro Compras found</Translate>
            </div>
          )
        )}
      </div>
