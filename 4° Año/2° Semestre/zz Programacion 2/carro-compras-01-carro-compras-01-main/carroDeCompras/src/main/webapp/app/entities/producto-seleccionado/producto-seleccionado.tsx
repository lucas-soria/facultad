  ...
  return (
    <div>
      <h2 id="producto-seleccionado-heading" data-cy="ProductoSeleccionadoHeading">
        <Translate contentKey="carroDeComprasApp.productoSeleccionado.home.title">Producto Seleccionados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="carroDeComprasApp.productoSeleccionado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="carroDeComprasApp.productoSeleccionado.home.createLabel">Create new Producto Seleccionado</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productoSeleccionadoList && productoSeleccionadoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="carroDeComprasApp.productoSeleccionado.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="carroDeComprasApp.productoSeleccionado.home.notFound">No Producto Seleccionados found</Translate>
            </div>
          )
        )}
      </div>
