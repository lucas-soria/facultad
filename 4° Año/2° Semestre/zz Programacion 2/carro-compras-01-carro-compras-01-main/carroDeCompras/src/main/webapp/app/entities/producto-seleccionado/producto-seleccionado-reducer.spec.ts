...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './producto-seleccionado.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IProductoSeleccionado, defaultValue } from 'app/shared/model/producto-seleccionado.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOSELECCIONADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOSELECCIONADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOSELECCIONADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOSELECCIONADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOSELECCIONADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOSELECCIONADO actions', async () => {
      const expectedActions = [
        {
