  ...
  return (
    <div>
      <h2 id="venta-heading" data-cy="VentaHeading">
        <Translate contentKey="carroDeComprasApp.venta.home.title">Ventas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="carroDeComprasApp.venta.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="carroDeComprasApp.venta.home.createLabel">Create new Venta</Translate>
          </Link>
        </div>
      </h2>
        ...
        {ventaList && ventaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="carroDeComprasApp.venta.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="carroDeComprasApp.venta.fecha">Fecha</Translate>
                </th>
                <th>
                  <Translate contentKey="carroDeComprasApp.venta.total">Total</Translate>
                </th>
                <th>
                  <Translate contentKey="carroDeComprasApp.venta.carro">Carro</Translate>
                </th>
                <th>
                  <Translate contentKey="carroDeComprasApp.venta.cliente">Cliente</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {ventaList.map((venta, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{venta.cliente ? venta.cliente.id : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="carroDeComprasApp.venta.home.notFound">No Ventas found</Translate>
            </div>
          )
        )}
      </div>
