...
import { actionTypes, addDistribuidor, updateDistribuidor, updateUser } from '../../reducer';
import Clientes from './Clientes';
import Distribuidores from './Distribuidores';

const theme = createTheme();

export default function AddDistribuidor({setReporte}) {
  ...
  const handleSubmit = async (event) => {
    ...
    const newDist = await addDistribuidor(tokenProducto,distData);
