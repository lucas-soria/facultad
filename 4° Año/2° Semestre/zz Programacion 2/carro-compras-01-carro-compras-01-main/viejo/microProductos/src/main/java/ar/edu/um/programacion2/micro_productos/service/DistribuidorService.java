...
public class DistribuidorService {
    ...
    public void delete(Long id) {
        ...
        Optional<DistribuidorDTO> distribuidorDTOOptional = distribuidorRepository.findById(id).map(distribuidorMapper::toDto);
        if (!distribuidorDTOOptional.isEmpty()) {
            DistribuidorDTO distribuidorDTO = distribuidorDTOOptional.get();
            if (distribuidorDTO.getHabilitado() == false) {
