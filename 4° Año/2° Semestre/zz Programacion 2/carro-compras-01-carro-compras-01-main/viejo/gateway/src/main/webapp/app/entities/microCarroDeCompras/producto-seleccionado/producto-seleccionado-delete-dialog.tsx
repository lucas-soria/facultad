...
export const ProductoSeleccionadoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.microCarroDeComprasProductoSeleccionado.delete.question">
        <Translate
          contentKey="gatewayApp.microCarroDeComprasProductoSeleccionado.delete.question"
          interpolate={{ id: productoSeleccionadoEntity.id }}
        >
