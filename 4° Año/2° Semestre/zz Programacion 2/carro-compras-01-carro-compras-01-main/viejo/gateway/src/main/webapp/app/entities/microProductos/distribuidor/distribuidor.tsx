  ...
  return (
    <div>
      <h2 id="distribuidor-heading" data-cy="DistribuidorHeading">
        <Translate contentKey="gatewayApp.microProductosDistribuidor.home.title">Distribuidors</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.microProductosDistribuidor.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.microProductosDistribuidor.home.createLabel">Create new Distribuidor</Translate>
          </Link>
        </div>
      </h2>
        ...
        {distribuidorList && distribuidorList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.microProductosDistribuidor.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.microProductosDistribuidor.home.notFound">No Distribuidors found</Translate>
            </div>
          )
        )}
      </div>
