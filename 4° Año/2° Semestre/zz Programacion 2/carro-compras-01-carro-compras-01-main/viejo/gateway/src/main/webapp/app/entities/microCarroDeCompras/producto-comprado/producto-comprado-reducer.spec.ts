...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './producto-comprado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOCOMPRADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOCOMPRADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOCOMPRADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOCOMPRADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOCOMPRADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOCOMPRADO actions', async () => {
      const expectedActions = [
        {
