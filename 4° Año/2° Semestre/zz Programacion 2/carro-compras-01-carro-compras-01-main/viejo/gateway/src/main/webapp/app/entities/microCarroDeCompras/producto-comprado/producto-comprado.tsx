  ...
  return (
    <div>
      <h2 id="producto-comprado-heading" data-cy="ProductoCompradoHeading">
        <Translate contentKey="gatewayApp.microCarroDeComprasProductoComprado.home.title">Producto Comprados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gatewayApp.microCarroDeComprasProductoComprado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gatewayApp.microCarroDeComprasProductoComprado.home.createLabel">Create new Producto Comprado</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productoCompradoList && productoCompradoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="gatewayApp.microCarroDeComprasProductoComprado.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gatewayApp.microCarroDeComprasProductoComprado.home.notFound">No Producto Comprados found</Translate>
            </div>
          )
        )}
      </div>
