  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gatewayApp.microProductosDistribuidor.home.createOrEditLabel" data-cy="DistribuidorCreateUpdateHeading">
            <Translate contentKey="gatewayApp.microProductosDistribuidor.home.createOrEditLabel">Create or edit a Distribuidor</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.microProductosDistribuidor.nombre')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.microProductosDistribuidor.descripcion')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.microProductosDistribuidor.habilitado')}
