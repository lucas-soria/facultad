...
export const ProductoSeleccionadoUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...productoSeleccionadoEntity,
          carroId: productoSeleccionadoEntity?.carro?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="gatewayApp.microCarroDeComprasProductoSeleccionado.home.createOrEditLabel"
            data-cy="ProductoSeleccionadoCreateUpdateHeading"
          >
            <Translate contentKey="gatewayApp.microCarroDeComprasProductoSeleccionado.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gatewayApp.microCarroDeComprasProductoSeleccionado.producto')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.microCarroDeComprasProductoSeleccionado.precio')}
              ...
              />
              <ValidatedField
                label={translate('gatewayApp.microCarroDeComprasProductoSeleccionado.cantidad')}
              ...
              <ValidatedField
                ...
                name="carroId"
                data-cy="carro"
                label={translate('gatewayApp.microCarroDeComprasProductoSeleccionado.carro')}
                type="select"
              >
                <option value="" key="0" />
                {carroCompras
