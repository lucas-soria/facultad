...
export const DistribuidorDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.microProductosDistribuidor.delete.question">
        <Translate contentKey="gatewayApp.microProductosDistribuidor.delete.question" interpolate={{ id: distribuidorEntity.id }}>
