...
export const ProductoCompradoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.microCarroDeComprasProductoComprado.delete.question">
        <Translate
          contentKey="gatewayApp.microCarroDeComprasProductoComprado.delete.question"
          interpolate={{ id: productoCompradoEntity.id }}
        >
