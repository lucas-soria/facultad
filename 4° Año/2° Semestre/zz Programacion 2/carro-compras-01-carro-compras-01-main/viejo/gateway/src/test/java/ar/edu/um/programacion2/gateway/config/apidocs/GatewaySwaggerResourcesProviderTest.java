package ar.edu.um.programacion2.gateway.config.apidocs;

import static ar.edu.um.programacion2.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
